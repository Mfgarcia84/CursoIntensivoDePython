'''
4.1 – Pizzas: Pense em pelo menos três tipos de pizzas favoritas. Armazene os nomes dessas pizzas
e, então, utilize um laço for para exibir o nome de cada pizza.
...
pizzas = ["calabresa", "quatro queijos", "marguerita"]
for pizza in pizzas:
